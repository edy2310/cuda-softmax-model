...
// CUDA launcher implemented in kernels/softmax_shared_memory.cu
...
torch::Tensor softmax_shared_forward(torch::Tensor input) {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward", &softmax_shared_forward, "Shared-memory softmax (CUDA)");
}
